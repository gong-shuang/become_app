 ...
 */
public class MiddleMainActivity extends AppCompatActivity implements OnClickListener {
	...
	public void onClick(View v) {
		if (v.getId() == R.id.btn_relative_xml) {
			...
			bundle.putString("request_time", "111111");
			bundle.putString("request_content", "222222");
